    ...
    <div className="max-w-3xl mx-auto px-6 py-16 text-[#383838]">
      ...
      <div className="text-center mb-10 animate-slide-up">
        <h1 className="text-4xl font-['Source_Serif_4',serif] text-[#242424] tracking-tight mb-3 font-medium">
          Optimiza tus prompts con un click.
        </h1>
        ...
        <div className="relative bg-white rounded-2xl border border-[#E5E5E5] shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all focus-within:shadow-[0_4px_12px_rgba(0,0,0,0.06)] focus-within:border-[#D4D4D4]">
          ...
          <div className="px-3 py-2 flex justify-between items-center border-t border-[#F0F0F0] bg-[#FAFAF9] rounded-b-2xl">
            <div className="flex items-center gap-2 px-2">
              ...
              <span className="text-[20px] text-[#6B6B6B] font-medium font-['Inter',sans-serif]">
                🦙
              </span>
            </div>
            <Button
      ...
      {result && !isLoading && (
        <div className="animate-fadeIn duration-700">
                  ...
                  <>
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={1.5}
                        d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 01-2-2V5"
                      />
                    </svg>
                    Copiar
                  </>
            ...
            <div className="bg-[#FAF9F6] px-6 py-5 border-t border-[#F0F0F0]">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-[#525252] leading-relaxed font-['Inter',sans-serif]">
                  <span className="font-semibold text-[#242424] block mb-1">
          ...
          <div className="mt-12 border-t border-[#E5E5E5] pt-8">
            <h3 className="text-xs font-semibold text-[#8a8a8a] uppercase tracking-wider mb-6 font-['Inter',sans-serif]">
              Cómo usar este prompt
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-['Inter',sans-serif]">
              <div className="flex flex-col gap-2">
                <div className="w-6 h-6 rounded-full bg-[#F0F0F0] flex items-center justify-center text-xs font-bold text-[#656565] font-mono">
                  1
                </div>
                <p className="text-sm text-[#656565] leading-relaxed">
                  ...
                  Usa el botón situado en la barra superior del resultado.
                </p>
              </div>
              <div className="flex flex-col gap-2">
                <div className="w-6 h-6 rounded-full bg-[#F0F0F0] flex items-center justify-center text-xs font-bold text-[#656565] font-mono">
                ...
                <p className="text-sm text-[#656565] leading-relaxed">
                  ...
                  Sustituye los textos entre{" "}
                  <span className="font-mono bg-[#F5F5F5] px-1 rounded text-xs text-[#DA7756]">
                    [corchetes]
                  </span>{" "}
                  con tu información.
                </p>
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-[#656565] leading-relaxed">
                  ...
                  Pega el prompt final en el chat para obtener la mejor
                  respuesta.
                </p>
              </div>
            </div>
