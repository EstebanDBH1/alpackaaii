            ...
            {result ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-center p-12 border-2 border-dashed border-gray-100 rounded-3xl bg-gray-50/50">
                 <div className="w-64 h-64 mb-6 opacity-80">
                    <img 
                        src="https://cdni.iconscout.com/illustration/premium/thumb/writer-writing-notes-illustration-download-in-svg-png-gif-file-formats--notepad-notebook-author-blogger-content-pack-people-illustrations-5100063.png" 
                        alt="Writing" 
